...
ActiveRecord::Schema[7.0].define(version: 20_231_228_075_052) do
  create_table 'amenities', force: :cascade do |t|
    ...
    t.index %w[hotel_id amenity_type name], name: 'index_amenities_on_hotel_id_and_amenity_type_and_name',
                                            unique: true
  ...
  create_table 'booking_conditions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[hotel_id condition], name: 'index_booking_conditions_on_hotel_id_and_condition', unique: true
  ...
  create_table 'images', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[hotel_id image_type link], name: 'index_images_on_hotel_id_and_image_type_and_link', unique: true
